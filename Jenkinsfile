	  ...
	  docker.withRegistry('', 'dockerhub') {
	    ...
	    sh "kubectl set image deployment blog-nodejs-deployment blog-v1="
          ...
          sshagent(['cloud_user']) {
             ...
             sh "ssh -o StrictHostKeyChecking=no cloud_user@172.31.29.238 -C \"kubectl set image deployment blog-nodejs-deployment blog-v1=kushwap1/blog-v1.0:$BUILD_NUMBER --record\""
                }
	}
    }
}
